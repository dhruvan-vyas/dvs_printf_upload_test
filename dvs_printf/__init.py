...
`style="help" for more info`.
        ...
        [self._style,self._speed,self._interval,self._stay,self._getmat
        ] = [self.style_setter,self.speed_setter,self.interval_setter,self.stay_setter,self.getmat_setter
        ] = [style,speed,interval,stay,getmat]
